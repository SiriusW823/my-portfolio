          ...
          <div className="space-y-6">
            {portfolioData.courses.map((course, index) => (
              <motion.div
                ...
                className="group p-6 rounded-xl bg-gray-900/50 border border-gray-800/50 hover:border-green-500/30 transition-all"
              >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {course.link && course.link !== '#' && (
                        <a href={course.link} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-400 transition-colors">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      <span className="text-gray-500 text-sm font-mono">{course.date}</span>
